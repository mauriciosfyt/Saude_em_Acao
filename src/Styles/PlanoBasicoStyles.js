...
const styles = StyleSheet.create({
    ...
    bannerText: { color: '#ffffff', fontSize: 14, fontWeight: 'bold' },

    title: { fontSize: 35, fontWeight: 'bold', color: '#111827', marginBottom: -2, marginTop: 10 },
    description: { fontSize: 11, lineHeight: 21, color: '#6b7280', marginBottom: 16 },
    ...
    modalidadeHint: { fontSize: 11, color: '#000000', fontWeight: 'bold', marginTop: 0, marginBottom: 25, letterSpacing: 0.5 },
    ...
    ctaButton: { backgroundColor: '#405CBA', paddingVertical: 10, borderRadius: 10, alignItems: 'center', marginTop: 5, width: 200, marginLeft: 48 },
