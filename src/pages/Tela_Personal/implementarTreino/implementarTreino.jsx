...
const EditIcon = (props) => (
  <svg {...props} width="16" height="16" className="adicionartreino-edit-icon-personal" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
  </svg>
);
const TrashIcon = (props) => (
  <svg {...props} width="16" height="16" className="adicionartreino-trash-icon-personal" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const ReorderArrows = ({ onUp, onDown, disabledUp, disabledDown, extraIcon, extraOnClick, upIconSrc, downIconSrc }) => (
  <div className="adicionartreino-reorder-arrows-personal" title="Reordenar">
    <button
      className="adicionartreino-arrow-btn-personal"
      onClick={onUp}
      disabled={disabledUp}
    ...
    >
      {upIconSrc ? (
        <img className="adicionartreino-arrow-img-personal" src={upIconSrc} alt="src/assets/icones/seta cima.png" />
      ) : (
        <svg className="adicionartreino-arrow-svg-personal" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      <div className="adicionartreino-handle-personal" aria-hidden>
        <span className="adicionartreino-handle-line-personal"></span>
        <span className="adicionartreino-handle-line-personal"></span>
      </div>
      {extraIcon ? (
        <button className="adicionartreino-extra-icon-personal" onClick={extraOnClick} aria-label="Extra">
          {extraIcon}
        </button>
      ) : null}
    </div>
    ...
    >
      {downIconSrc ? (
        <img className="adicionartreino-arrow-img-personal" src={downIconSrc} alt="src/assets/icones/seta baixo.png" />
      ) : (
        <svg className="adicionartreino-arrow-svg-personal" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function ImplementarTreino() {
  ...
  return (
    <div className="adicionartreino-page-personal">
      <MenuPersonal />
      <main className="adicionartreino-main-content-personal">
        {/* CORREÇÃO: Wrapper adicionado para centralizar e limitar a largura */}
        <div className="adicionartreino-form-wrapper-personal">
            <h1 className="adicionartreino-form-title-personal">Adicionar Treinos</h1>

            {/* --- Formulário Principal --- */}
            <div className="adicionartreino-form-container-personal">
              <div className="adicionartreino-form-row-personal  adicionartreino-form-row-personal-2">
                <div className="adicionartreino-form-field-personal">
              ...
              <div className="adicionartreino-form-row-personal adicionartreino-form-row-3">
                <div className="adicionartreino-form-field-personal">
              ...
              <div className="adicionartreino-form-row-personal  adicionartreino-form-row-personal-3">
                <div className="adicionartreino-form-field-personal">
            ...
            {/* --- Abas de Navegação --- */}
            <nav className="adicionartreino-tabs-nav-personal">
              {dias.map((dia) => (
                <button
                  key={dia}
            ...
            {/* --- Seção de Exercícios --- */}
            <div className="adicionartreino-exercicios-section-personal">
              <button className="adicionartreino-add-exercise-btn-personal" onClick={addExercise} type="button">
                <PlusIcon /> Exercício
              </button>

              {/* Cabeçalho visível apenas em telas maiores */}
              <div className="adicionartreino-exercise-header-personal">
              ...
              {/* Lista de Exercícios */}
              <div className="adicionartreino-exercicios-list-personal" ref={listRef}>
                {currentList.map((item, index) => (
                  <div
                    key={item.id}
                    className={`adicionartreino-exercise-row-personal`}
                    ref={(el) => {
                  ...
                  >
                    <div className="adicionartreino-field-content-personal adicionartreino-reorder-col-personal">
                      <ReorderArrows
                    ...
                    <div className="adicionartreino-field-content-personal adicionartreino-exercise-name-col-personal">
                        <label className="adicionartreino-mobile-label-personal">Exercício *</label>
            <input type="text" defaultValue={item.nome} />
                    </div>

                    <div className="adicionartreino-field-content-personal adicionartreino-series-col-personal">
                        <label className="adicionartreino-mobile-label-personal">Séries *</label>
            <input type="number" defaultValue={item.series} />
                    </div>

                    <div className="adicionartreino-field-content-personal adicionartreino-repeticoes-col-personal">
                        <label className="adicionartreino-mobile-label-personal">Repetições</label>
            <input type="number" defaultValue={item.repeticoes} />
                    </div>

                    <div className="adicionartreino-field-content-personal adicionartreino-carga-col-personal">
                      <label className="adicionartreino-mobile-label-personal">Carga(KG)</label>
                      <div className="adicionartreino-inline-input-wrapper-personal">
                        <input type="text" placeholder="--" defaultValue={item.carga} />
                        <InfoIcon />
                      </div>
                    </div>

                    <div className="adicionartreino-field-content-personal adicionartreino-intervalo-col-personal">
                      <label className="adicionartreino-mobile-label-personal">Intervalo</label>
                      <div className="adicionartreino-inline-input-wrapper-personal">
                    ...
                    <div className="adicionartreino-field-content-personal adicionartreino-observacao-col-personal">
                        <label className="adicionartreino-mobile-label-personal">Observação</label>
            <input type="text" placeholder="--" defaultValue={item.obs} />
                    </div>

                    <div className="adicionartreino-field-content-personal adicionartreino-actions-col-personal">
                      <button className="adicionartreino-icon-btn-personal" title="Editar"><EditIcon /></button>
                      <button className="adicionartreino-icon-btn-personal" title="Excluir" onClick={() => deleteExercise(item.id)}><TrashIcon /></button>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="adicionartreino-footer-buttons">
              <button className="adicionartreino-btn-personal adicionartreino-btn-cancel-personal">Cancelar</button>
              <button className="adicionartreino-btn-personal adicionartreino-btn-save-personal">Salvar</button>
            </div>
        </div>
      </main>
    </div>
