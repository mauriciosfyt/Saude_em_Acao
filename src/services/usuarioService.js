...
// Em produção, defina KNOW_API_URL no GitHub Actions (ex: http://23.22.153.89:8080)
...
export const API_URL = (import.meta.env.KNOW_API_URL || 'http://23.22.153.89:8080') + '/api';
