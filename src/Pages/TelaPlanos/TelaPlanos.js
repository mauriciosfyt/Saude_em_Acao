  ...
  const planos = [
    {
      id: 'basico',
      titulo: 'Plano Básico',
      descricao: 'Nosso plano mais econômico e acessível para você se exercitar o quanto e quando quiser.',
      preco: 'R$120,00',
      bannerText: null,
    },
    {
      ...
      descricao: 'O plano de academia ideal, que oferece resultados completo por um preço acessível. Nele inclui acesso a todas as modalidades e acompanhamento profissional de um professor para montar seus treino presonalizados.',
      preco: 'R$159,90',
    ...
    },
    {
      id: 'gold',
      titulo: 'Plano Gold',
      descricao: 'O plano de academia ideal, que oferecer resultados completo por um preço acessível. Nele inclui acesso a todas as modalidades e acompanhamento profissional de um professor para montar seus treino presonalizados.',
      preco: 'R$300,00',
  ...
  const renderPlano = (plano) => {
    return (
      ...
      >
        ...
        <Text style={[styles.planTitle, { color: plano.id === 'gold' ? '#fbbf24' : '#111827' }]}>
          {plano.titulo}
        </Text>
        <Text style={[styles.planDescription, { color: plano.id === 'gold' ? '#d1d5db' : '#6b7280' }]}>
          {plano.descricao}
        </Text>
        <Text style={[styles.planPrice, { color: plano.id === 'gold' ? '#ffffff' : '#111827' }]}> 
          Por apenas
        </Text>
        <Text style={[styles.planPrice, { color: plano.id === 'gold' ? '#ffffff' : '#111827', marginTop: -8 }]}> 
          {plano.preco}
        </Text>
        <TouchableOpacity 
