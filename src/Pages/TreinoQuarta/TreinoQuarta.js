...
const TreinoQuarta = ({ navigation, route }) => {
  console.log('Renderizando TreinoQuarta');
    ...
    perna: [
      {
        ...
        descricao: 'Fique em pé com os pés afastados na largura dos ombros, segure a barra sobre os ombros e agache flexionando os joelhos até formar um ângulo de 90°. Retorne à posição inicial.',
      },
      {
        id: 2,
        ...
        descricao: 'Sente-se no aparelho, posicione os pés na plataforma e empurre-a até estender as pernas, depois flexione os joelhos controlando o movimento.',
      },
      {
        id: 3,
        ...
        descricao: 'Sente-se no banco extensor, ajuste o apoio nos tornozelos e eleve as pernas até estender os joelhos, retornando devagar.',
      },
      {
        id: 4,
        ...
        descricao: 'Deite-se na mesa flexora, posicione os tornozelos sob o apoio e flexione os joelhos trazendo os pés em direção ao glúteo, depois retorne.',
      },
      {
        id: 5,
        nome: 'Abdutora(Perna)',
        ...
        carga: 0,
        imagem: require('../../../assets/banner_camisas.png'),
        descricao: 'Sente-se no aparelho abdutora, posicione as pernas contra os apoios e afaste-as lateralmente, retornando ao centro com controle.',
      },
      {
        id: 6,
        ...
        descricao: 'Sente-se no banco, apoie a ponta dos pés na plataforma e eleve os calcanhares, contraindo a panturrilha. Retorne devagar à posição inicial.',
      },
    ],
  };
  // Corrige erro de variável não definida
  ...
  const handleSelecionarExercicios = () => {
    if (exerciciosConcluidos === totalExercicios) {
      ...
      exercicios.perna.forEach(exercicio => {
