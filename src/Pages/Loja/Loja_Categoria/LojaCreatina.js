...
import { obterProdutos } from '../../../Services/api'; // Ajuste o caminho se necessário
  ...
  useEffect(() => {
    const carregarProdutos = async () => {
      try {
        ...
        // 1. Busca os dados da API, já filtrando por 'CREATINA'
        const data = await obterProdutos({ categoria: 'CREATINA' }); 
        ...
        <View style={styles.produtosContainer}>
          {produtos.slice(0, 4).map((produto) => (
            ...
            >
              ...
              {/* O botão de favorito continua clicável independentemente */}
